...
Measured at `d5184b7cededc300d0915130138803ed65f52bf5` on `agent/conformance-advisory`.
...
| --- | ---: | ---: | ---: | ---: | ---: |
| `cmp` | 183 / 241 | 75.9% | 0 / 8 | 195 | 2 |
| `androidx-jvm` | 133 / 241 | 55.2% | 0 / 8 | 358 | 1 |
...
| both fail | 59 | An expectation that survives neither implementation, or a probe neither lane has. |
...
| outcome | golds | what it means |
| --- | ---: | --- |
| both pass | 172 | Settled. Neither lane disagrees. |
| only `typescript` passes | **33** | **The work list**, split below into the player's gaps and this runner's. |
