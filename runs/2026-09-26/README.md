...
Measured at `11c7226812a608f5d60ddb26602c976c86a5ba73` on `main`.

## Lanes

| lane | core golds | pass rate | extended | raster disagreements | errored |
| --- | ---: | ---: | ---: | ---: | ---: |
| `cmp` | 315 / 353 | 89.2% | 7 / 8 | 113 | 20 |
| `native-appkit` | 311 / 353 | 88.1% | 7 / 8 | 227 | 0 |
...
| --- | ---: | --- |
| both pass | 322 | Settled. Neither lane disagrees. |
| only `typescript` passes | **38** | **The work list**, split below into the player's gaps and this runner's. |
...
**18 the player: the reference draws or reports it and this one does not.**
...
28 frames are unique to `cmp` — see the results JSON.
