...
| 13 — Pure Swift core | In progress | Kotlin runtime dependency removed; legacy/modern headers, the editable custom fixture, and Morning Run structure/text decode in Swift; broader operation coverage remains |
