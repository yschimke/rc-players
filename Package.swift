...
let package = Package(
  ...
  targets: [
    .binaryTarget(
      name: "RcComposePlayer",
      url:
        "https://github.com/yschimke/rc-players/releases/download/v1.60.1/RcComposePlayer.xcframework.zip",
      ...
      checksum: "bce1801c4fb2e7568d10d8a1d98ce9f0aac31fbd8cf6d728266f8179009f7a55"
    ),
