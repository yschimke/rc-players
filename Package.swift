...
let package = Package(
  ...
  targets: [
    .binaryTarget(
      name: "RcComposePlayer",
      url:
        "https://github.com/yschimke/rc-players/releases/download/v1.59.1/RcComposePlayer.xcframework.zip",
      ...
      checksum: "32b81b497eab8f7e92b6b68514be71bcd71d9c125f9f3dbf18b305bf6b2ed5d9"
    )
  ]
)
