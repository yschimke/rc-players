...
let package = Package(
  ...
  targets: [
    .binaryTarget(
      name: "RcComposePlayer",
      url:
        "https://github.com/yschimke/rc-players/releases/download/v1.61.1/RcComposePlayer.xcframework.zip",
      ...
      checksum: "3036cddc0b0fef51745c11a21f04f3bdd157aec8da3c5c103442a6198dcf9eaf"
    ),
