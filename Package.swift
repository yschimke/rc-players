...
if !nativeOnly {
  targets.insert(
    .binaryTarget(
      ...
      url:
        "https://github.com/yschimke/rc-players/releases/download/v1.72.0/RcComposePlayer.xcframework.zip",
      ...
      checksum: "b054210cdcd0eb73a51af6afb603a88bc848f1bffb81b02f2f39171ce35bba87"
    ), at: 0)
}
