...
if !nativeOnly {
  targets.insert(
    .binaryTarget(
      ...
      url:
        "https://github.com/yschimke/rc-players/releases/download/v1.75.0/RcComposePlayer.xcframework.zip",
      ...
      checksum: "66b87a7234c9087e6554f8b831810463ce25e37c5ed1ad45c4538e69d4e6eaef"
    ), at: 0)
}
