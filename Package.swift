...
let package = Package(
  ...
  targets: [
    .binaryTarget(
      name: "RcComposePlayer",
      url:
        "https://github.com/yschimke/rc-players/releases/download/v1.65.0/RcComposePlayer.xcframework.zip",
      ...
      checksum: "1e908db6ca0311677ff8bf27a1a40205c07d91139de0842b1634d194547fa789"
    ),
