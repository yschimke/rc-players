// TextAttribute: measure text or get text length, store result as a float.
// Matches Java TextAttribute.java (opcode 170).
...
export class TextAttribute extends PaintOperation {
    static readonly OP_CODE = 170;
    private mId: number;
    ...
    static read(buffer: WireBuffer, operations: Operation[]): void {
        ...
        operations.push(new TextAttribute(id, textId, type));
    }
}
