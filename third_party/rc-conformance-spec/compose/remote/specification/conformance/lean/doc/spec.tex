...
\begin{tabular}{@{}lr@{}}
\toprule
Documents in scope & \textbf{109} \\
Viewport configurations checked & \textbf{325} \\
Geometry failures & \textbf{0} \\
Visibility failures & \textbf{0} \\
Documents skipped as out of scope & 65 \\
\bottomrule
\end{tabular}
\end{center}
...
\midrule
10 & modifier \jv{offset}             &  3 & column alignment \\
10 & modifier \jv{visibility}         &  2 & autosize step inequality quirk \\
 8 & \jv{stateLayout} anim. container &  1 & \jv{canvas} \\
 7 & modifier \jv{verticalScroll}     &  1 & \jv{image} \\
 5 & modifier \jv{animationSpec}      &  1 & \jv{heightIn} without height modifier \\
 4 & multiline text                   &  1 & modifier \jv{alignByBaseline} \\
 4 & \jv{widthIn} without width mod.  &  1 & modifier \jv{fillParentMaxWidth} \\
 3 & modifier \jv{horizontalScroll}   &  1 & modifier \jv{marquee} \\
   &                                  &  1 & modifier \jv{multiClick} \\
   &                                  &  1 & malformed component \\
   &                                  &  1 & modifier \jv{wrapContentSize} \\
\bottomrule
\end{tabular}
\end{center}

The test suite now incorporates the newly introduced container and text operations: all \jv{fitBox} documents in the gold suite are fully supported (8 in scope, 2 skipped solely due to unmodelled decorative \jv{offset}/\jv{visibility} child modifiers), along with single-line fixed and autosizing \jv{text} components. This expands automated machine-checked conformance coverage from 99 to 109 documents and from 294 to 325 checked viewport configurations.
...
\file{Node.lean} & Sections 3.3, 6.1, 8.4: trees, weights, priorities & 423 \\
\file{Measure.lean} & Sections 5--9: the algorithm & 1207 \\
\file{Theorems.lean} & Section 10: structural properties & 509 \\
\file{Optimizations.lean} & Section 11: optimization passes and invariants & 364 \\
...
\file{Conformance.lean} & Generated: 109 documents, 325 checks & 905 \\
\file{RemoteComposeLayout.lean} & Root module aggregation & 14 \\
\file{tools/gen\_conformance.py} & The corpus translator & 548 \\
\bottomrule
\end{tabular}
\end{center}
