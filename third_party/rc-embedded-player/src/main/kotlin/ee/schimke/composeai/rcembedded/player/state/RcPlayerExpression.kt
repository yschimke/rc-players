...
package ee.schimke.composeai.rcembedded.player.state
...
private val IMPERATIVE_OPCODES: Set<Int> =
    hashSetOf(
        AnimatedFloatExpression.fromNaN(AnimatedFloatExpression.RAND),
        AnimatedFloatExpression.fromNaN(AnimatedFloatExpression.RAND_SEED),
        AnimatedFloatExpression.fromNaN(AnimatedFloatExpression.NOISE_FROM),
        AnimatedFloatExpression.fromNaN(AnimatedFloatExpression.RAND_IN_RANGE),
        AnimatedFloatExpression.fromNaN(AnimatedFloatExpression.STORE_RO),
        AnimatedFloatExpression.fromNaN(AnimatedFloatExpression.STORE_R1),
        AnimatedFloatExpression.fromNaN(AnimatedFloatExpression.STORE_R2),
        AnimatedFloatExpression.fromNaN(AnimatedFloatExpression.STORE_R3),
        AnimatedFloatExpression.fromNaN(AnimatedFloatExpression.LOAD_R0),
        AnimatedFloatExpression.fromNaN(AnimatedFloatExpression.LOAD_R1),
        AnimatedFloatExpression.fromNaN(AnimatedFloatExpression.LOAD_R2),
        AnimatedFloatExpression.fromNaN(AnimatedFloatExpression.LOAD_R3),
        AnimatedFloatExpression.fromNaN(AnimatedFloatExpression.VAR1),
        AnimatedFloatExpression.fromNaN(AnimatedFloatExpression.VAR2),
        AnimatedFloatExpression.fromNaN(AnimatedFloatExpression.VAR3),
        AnimatedFloatExpression.fromNaN(AnimatedFloatExpression.A_DEREF),
        AnimatedFloatExpression.fromNaN(AnimatedFloatExpression.A_MAX),
        AnimatedFloatExpression.fromNaN(AnimatedFloatExpression.A_MIN),
        AnimatedFloatExpression.fromNaN(AnimatedFloatExpression.A_SUM),
        AnimatedFloatExpression.fromNaN(AnimatedFloatExpression.A_AVG),
        AnimatedFloatExpression.fromNaN(AnimatedFloatExpression.A_LEN),
        AnimatedFloatExpression.fromNaN(AnimatedFloatExpression.A_SPLINE),
        AnimatedFloatExpression.fromNaN(AnimatedFloatExpression.A_SPLINE_LOOP),
        AnimatedFloatExpression.fromNaN(AnimatedFloatExpression.A_SUM_TILL),
        AnimatedFloatExpression.fromNaN(AnimatedFloatExpression.A_SUM_XY),
        AnimatedFloatExpression.fromNaN(AnimatedFloatExpression.A_SUM_SQR),
        AnimatedFloatExpression.fromNaN(AnimatedFloatExpression.A_LERP),
    )
...
public fun rememberRemoteExpression(id: Int): State<Float> {
    ...
    val varStates = HashMap<Int, State<Float>>(varIds.size)
    for (i in 0 until varIds.size) {
        val varId = varIds[i]
        varStates[varId] = rememberRemoteFloatAsState(varId)
    }
