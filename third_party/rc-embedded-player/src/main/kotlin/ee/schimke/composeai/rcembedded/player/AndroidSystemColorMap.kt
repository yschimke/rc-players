...
// LOCAL PATCH (rc-players): a copy of `remote-creation-compose`'s `AndroidSystemColorMap` from
// androidx-main, because the `1.0.0-alpha19` artifacts this module compiles against predate it.
// Delete this file, and the import in `AndroidColorThemeResolver.kt`, once the pinned
// `compose-remote` release ships it. See PROVENANCE.md.
 ...
 * color group.
 */
internal object AndroidSystemColorMap {
