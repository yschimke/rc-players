...
private val dbtaFontIdField =
  DrawBitmapTextAnchored::class.java.getDeclaredField("mBitmapFontID").apply { isAccessible = true }
...
private val db2Value1Field =
  androidx.compose.remote.core.operations.DrawBase2::class.java.getDeclaredField("mValue1").apply {
    isAccessible = true
  }
private val db2Value2Field =
  androidx.compose.remote.core.operations.DrawBase2::class.java.getDeclaredField("mValue2").apply {
    isAccessible = true
  }
...
private val db3Value1Field =
  androidx.compose.remote.core.operations.DrawBase3::class.java.getDeclaredField("mValue1").apply {
    isAccessible = true
  }
private val db3Value2Field =
  androidx.compose.remote.core.operations.DrawBase3::class.java.getDeclaredField("mValue2").apply {
    isAccessible = true
  }
private val db3Value3Field =
  androidx.compose.remote.core.operations.DrawBase3::class.java.getDeclaredField("mValue3").apply {
    isAccessible = true
  }
...
private val db4X1ValueField =
  androidx.compose.remote.core.operations.DrawBase4::class.java.getDeclaredField("mX1Value").apply {
    isAccessible = true
  }
private val db4Y1ValueField =
  androidx.compose.remote.core.operations.DrawBase4::class.java.getDeclaredField("mY1Value").apply {
    isAccessible = true
  }
private val db4X2ValueField =
  androidx.compose.remote.core.operations.DrawBase4::class.java.getDeclaredField("mX2Value").apply {
    isAccessible = true
  }
private val db4Y2ValueField =
  androidx.compose.remote.core.operations.DrawBase4::class.java.getDeclaredField("mY2Value").apply {
    isAccessible = true
  }
...
private val db6Value1Field =
  androidx.compose.remote.core.operations.DrawBase6::class.java.getDeclaredField("mValue1").apply {
    isAccessible = true
  }
private val db6Value2Field =
  androidx.compose.remote.core.operations.DrawBase6::class.java.getDeclaredField("mValue2").apply {
    isAccessible = true
  }
private val db6Value3Field =
  androidx.compose.remote.core.operations.DrawBase6::class.java.getDeclaredField("mValue3").apply {
    isAccessible = true
  }
private val db6Value4Field =
  androidx.compose.remote.core.operations.DrawBase6::class.java.getDeclaredField("mValue4").apply {
    isAccessible = true
  }
private val db6Value5Field =
  androidx.compose.remote.core.operations.DrawBase6::class.java.getDeclaredField("mValue5").apply {
    isAccessible = true
  }
private val db6Value6Field =
  androidx.compose.remote.core.operations.DrawBase6::class.java.getDeclaredField("mValue6").apply {
    isAccessible = true
  }
...
private val dbmpRightField =
  androidx.compose.remote.core.operations.DrawBitmap::class.java.getDeclaredField("mRight").apply {
    isAccessible = true
  }
private val dbmpBottomField =
  androidx.compose.remote.core.operations.DrawBitmap::class.java.getDeclaredField("mBottom").apply {
    isAccessible = true
  }
...
private val bmpDataBitmapField =
  androidx.compose.remote.core.operations.BitmapData::class.java.getDeclaredField("mBitmap").apply {
    isAccessible = true
  }
...
private val valIntChangeTargetField =
  androidx.compose.remote.core.operations.layout.modifiers.ValueIntegerChangeActionOperation::class
    .java
