 ...
 * caller wraps it as a Compose [androidx.compose.ui.graphics.Brush] (and keeps it for SHADER_MATRIX).
 *
 ...
 */
internal fun applyShaderMatrix(paintState: ComposeLocalPaint, matrixWord: Int, read: RemoteContext) {
