...
Of 113 frames where `cmp` disagrees with the reference image, 85 are frames a reference lane fails too. 28 are the subject lane's alone — and that is the number worth acting on.
